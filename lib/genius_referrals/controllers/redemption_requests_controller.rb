...
module GeniusReferrals
  class RedemptionRequestsController < BaseController
    ...
    # @param [String] account_slug Required parameter: The account identifier
    # @param [String] page Optional parameter: Page number, e.g. 1 would start at the first result, and 10 would start at the tenth result.
    # @param [String] limit Optional parameter: Maximum number of results to return in the response. Default (10), threshold (100)
