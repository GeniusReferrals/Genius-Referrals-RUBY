  ...
  class BaseController
    ...
    def validate_response(context)
      if context.response.status_code == 401
        raise APIException.new 'You are not authenticated', context
      elsif context.response.status_code == 403
        raise APIException.new 'User not authorized to perform the operation', context
      elsif context.response.status_code == 404
        raise APIException.new 'Resource not found', context
